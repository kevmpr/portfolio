...
const aboutmeInfoTitle = document.querySelectorAll(".aboutme__info__title");
...
const darkMode = () => {
  ...
  aboutmeInfoTitle.forEach((element) => {
    element.classList.add("aboutme__info__title--darkmode");
  });
...
const lightMode = () => {
  ...
  aboutmeInfoTitle.forEach((element) => {
    element.classList.remove("aboutme__info__title--darkmode");
  });
  skillTitle.forEach((element) => {
